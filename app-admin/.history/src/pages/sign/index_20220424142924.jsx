...
import { getSignList, addSign, updateSign } from '@/services/sign';
...
class UserForm extends BaseForm {
  ...
  handleSubmit = async () => {
    ...
    await updateSign(this.props.initialValues?._id, validateValue);
...
export default class Component extends BaseTable {
  ...
  handleDelete = async (ids) => {
    const query = `mutation DelSign($ids: [ID]) {
      delSign(ids: $ids)
    }`;
    const variables = {
      ids,
