...
import { addInfo, getInfoList, updateInfo } from '@/services/info';
...
class UserForm extends BaseForm {
  ...
  handleSubmit = async () => {
    ...
    await updateInfo(this.props.initialValues?._id, validateValue);
...
export default class Component extends BaseTable {
  ...
  handleDelete = async (ids) => {
    const query = `mutation DelInfo($ids: [ID]) {
      delInfo(ids: $ids)
    }`;
    const variables = {
      ids,
  ...
  getData = async (params = {}) => {
    ...
    const res = await getInfoList(filters, current, pageSize);
    return res;
  };
