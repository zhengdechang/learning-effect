...
class AnswerSheet extends BaseForm {
  ...
  handleSubmit = async () => {
    ...
    let scoreUnique = _.pickBy(answers.other, (value, key) => {
      return key.includes('_');
    });

    scoreUnique = Object.keys(scoreUnique).map((item) => {
      return {
        [item.slice(0, 24)]: scoreUnique?.[item],
      };
    });
    console.log('score: ', scoreUnique);
