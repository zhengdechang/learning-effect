      ...
      },
      {
        ...
        render: (text, record, _, action) => {
          ...
          return [
            <UserForm
              key="1"
              modalRefEdit={this.modalRefEdit}
              getModalFormOptions={() => this.getModalFormOptions(true, record)}
...
const UserForm = (props) => {
  return <BaseForm ref={this.props.modalRefEdit} {...this.props.getModalFormOptions()} />;
};
